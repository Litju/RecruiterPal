...
test("Northstar demo keeps Pal context, command navigation, and evidence workspace visible", async ({
  page,
}) => {
  ...
  await expect(
    page.getByRole("complementary", { name: "Pal contextual execution pane" }),
  ).toBeVisible();
