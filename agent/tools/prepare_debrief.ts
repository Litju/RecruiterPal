...
export default defineTool({
  description:
    "Prepare an evidence-linked debrief view for an application. It summarizes recorded observations and disagreements without ranking a candidate.",
  inputSchema: idInput,
    ...
    return readWithTenant(access, async (tx) => {
      ...
      return {
        ...
        data: {
          ...
          note: "This debrief contains evidence only; it is not a candidate ranking or employment decision.",
        },
      };
    });
  },
